...
export default function CollectionPage() {
  ...
  const collectionSlug = typeof slug === 'string' ? slug : '';
  const pageTitle = COLLECTION_TITLES[collectionSlug] || "Collection";
  ...
  const fetchProducts = useCallback(async (pageNum: number, currentFilters: FilterState, currentSort: string) => {
    ...
    try {
      ...
      const res = await apiClient(`/products/collections-slug/${collectionSlug}?${queryParams.toString()}`);
